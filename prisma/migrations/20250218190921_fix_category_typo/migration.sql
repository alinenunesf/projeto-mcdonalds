/*
  ...
  - You are about to drop the column `manuCategoryId` on the `Product` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "Product" DROP CONSTRAINT "Product_manuCategoryId_fkey";

-- AlterTable
ALTER TABLE "Product" DROP COLUMN "manuCategoryId",
